...
namespace PayrollSoftware
{
    ...
    class FileReader
    {
        ...
        {
            List<Staff> myStaff = new List<Staff>(); //create an empty list of Staffs
            string[] result = new string[2]; 
            string path = "Staff.txt"; //name of staff file
            string[] separator = { ", " };
    ...
    class PaySlip
    {
        ...
        enum MonthsOfYear { //private by default
        ...
        /*Generate a Summary of a list of staffs
         * 
         * 
         * 
         * 
